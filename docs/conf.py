...
project = 'molecool'
copyright = ("2020, Warren. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'molecool', 'molecool Documentation',
     author, 'molecool', 'A python package for analysing and visualising pdb abd xyz files. For molssi May webinar series',
     'Miscellaneous'),
]
